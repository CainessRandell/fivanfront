...
## Frontend React (estrutura inicial)

Foi adicionada a estrutura inicial em `frontend/` com React + Vite + Styled Components.
...
- Login e registro (`/auth/login`, `/auth/register`)
- Listagem de posts autenticada (`GET /posts`)
- CRUD de posts para perfil professor (`POST/PUT/DELETE /posts`)
- Estilizacao responsiva com Styled Components
